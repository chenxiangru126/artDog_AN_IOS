            ...
            <div class="goods_evaluation">
                ...
                <div class="evaluation" v-for="(it,i) in evaluation" :key="i" >
                    ...
                    <div class="content">
                        ...
                        <p class="operation"><span @click="like(it)" :class="it.myDianzhan==1?'give_like1':'give_like'">{{it.dianzanCount}}</span><span class="message" style="display:none;">{{it.pinglunCount}}</span></p>
                    </div>
                </div>
            </div>
