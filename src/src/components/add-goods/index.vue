    ...
    <div class="entry_b">
        ...
        <div class="up">
            ...
            <div class="up_r">
                ...
                <div class="up_img"><i  @click="library" class='iconfont icon-shanchu1 deletImg' style='font-size: 33px;color: #dfe5eb;' ></i><span>删除图片</span></div>

                <!-- <div class="shanchu_img" ><i class="iconfont" icon-shanchu1></i></div> -->
            </div>
